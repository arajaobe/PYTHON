...
# Top-level imports are wrapped in a try-except block.
# If dependencies are missing, this prevents an immediate crash.
# The script will gracefully exit later in check_programs().
# This is the "mechanic" to satisfy both runtime safety and mypy/flake8.
try:
    import numpy as np
    import pandas as pd
