...
def gen_player_achievements(achievements_list: list[str]) -> set:
...
def main():
	...
	print(f"{player1.name} is missing:", set.difference(set_achievements, set.union(player1.achievements)))
	print(f"{player2.name} is missing:", set.difference(set_achievements, set.union(player2.achievements)))
	print(f"{player3.name} is missing:", set.difference(set_achievements, set.union(player3.achievements)))
	print(f"{player4.name} is missing:", set.difference(set_achievements, set.union(player4.achievements)))
